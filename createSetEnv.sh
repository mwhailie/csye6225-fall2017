...
echo 'JAVA_OPTS="$JAVA_OPTS -Dspring.datasource.url=jdbc:mysql://csye6225-fall2017.cuyuii1ixvbr.us-east-1.rds.amazonaws.com:3306/csye6225"'  | sudo tee --append /usr/share/tomcat8/bin/setenv.sh
